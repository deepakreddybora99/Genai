...
# Title and subtitle
st.markdown('<p style="{}">🚀 Welcome to Data Science Tutor🌌</p>'.format(";".join([f"{k}:{v}" for k, v in title_style.items()])), unsafe_allow_html=True)
...
model = gemini.GenerativeModel(model_name="gemini-1.5-pro-latest",
                               system_instruction="""You are tasked to resolve only data science and its career
                               doubts of the user.""")
